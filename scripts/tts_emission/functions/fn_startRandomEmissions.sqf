/*
	...
	Parameters:
		0: NUMBER (OPTIONAL) - Minimum number of seconds between one emission ending and the next one starting. Default is 1800 (30 minutes).
		1: NUMBER (OPTIONAL) - Maximum number of seconds between one emission ending and the next one starting. Default is 2700 (45 minutes).
